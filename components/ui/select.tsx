...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:border-primary/60',
      'disabled:cursor-not-allowed disabled:opacity-50',
      '[&>span]:line-clamp-1',
      // RTL: icon should appear on the left in RTL, logical end
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 shrink-0 text-muted-foreground rtl-flip" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'py-1.5 ps-8 pe-2 text-sm outline-none',
      'text-foreground',
    ...
    {...props}
  >
    {/* Check indicator — positioned inline-start */}
